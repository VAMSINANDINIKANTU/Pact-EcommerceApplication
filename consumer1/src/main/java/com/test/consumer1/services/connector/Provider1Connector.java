...
public class Provider1Connector {
	...
	public Provider1Connector(String providerRootUri, RestTemplateBuilder restTemplateBuilder,
		ObjectMapper objectMapper) {
		this.restTemplate = restTemplateBuilder.rootUri(URI.create(providerRootUri).toString())
